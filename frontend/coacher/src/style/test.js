jQuery(document).ready(function ($) {
	...
	$(".dash-item__nav").each(function () {
		$(this)
			.addClass("dash-item__nav--collapsible")
			.attr("aria-hidden", true)
			.before(
				'<button class="dash-item__menu-action" type="button" aria-expanded="false" aria-controls="' +
					$(this).attr("id") +
					'"><svg class="dash-item__menu-action__icon dash-item__menu-action__icon--bottom"><use xlink:href="#icon-chevron" /></svg><svg class="dash-item__menu-action__icon dash-item__menu-action__icon--top"><use xlink:href="#icon-chevron" /></svg></button>'
			);
	});
